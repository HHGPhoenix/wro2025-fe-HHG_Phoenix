...
class Servo:
    def __init__(self, pin, minPulse=500, maxPulse=2500, minAngle=0, middleAngle=90, maxAngle=180):
        ...
        self.pwm = DummyPWM(pwm_channel=0, hz=50, chip=0)
        self.pwm.start(7.5)  # 7.5% duty cycle corresponds to 1.5ms pulse width (90 degrees)
    ...
    def setAngle(self, angle):
        ...
        dutyCycle = (pulseWidthMicroseconds / 20000) * 100
